...
#ifndef TooNew_MJGAvailability_h
#define TooNew_MJGAvailability_h

// Get from: https://github.com/mattjgalloway/MJGFoundation
//=========================================================
//  MJGImageLoader.h
//  MJGFoundation
//
...
#define __AVAILABILITY_TOO_NEW __attribute__( ( weak_import, deprecated("TOO NEW!") ) )
